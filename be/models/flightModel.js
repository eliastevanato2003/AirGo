...
exports.getFlights = async (id, departure, arrival, mindatestart, maxdatestart, mindatearrival, maxdatearrival) => {
    ...
    const result = await pool.query(sql, [id, departure, arrival, mindatestart, maxdatestart, mindatearrival, maxdatearrival]);
    return result.rows;
}
