...
exports.getPlanes = async (id, airline, model, constructionyear) => {
    const as1 = 'SELECT "IdAereo", "AnnoCostruzione", "IdCompagniaAerea", "C"."Nome", "C"."CodiceIdentificativo", "IdModello", "M"."Nome" ';
    ...
    const whe = 'WHERE ("IdAereo" = $1 OR $1 IS NULL) AND ("CompagniaAerea" = $2 OR $2 IS NULL) AND ("Modello" = $3 OR $3 IS NULL) AND ("AnnoCostruzione" = $4 OR $4 IS NULL) AND "IsActive" = true';
