...
exports.getFlightRoutes = async (id, departure, arrival, airline) => {
    ...
    const joi = 'FROM "Rotte" JOIN "Aeroporti" AS "A1" ON "A1"."IdAeroporto" = "Partenza" JOIN "Aeroporti" AS "A2" ON "A2"."IdAeroporto" = "Destinazione" JOIN "CompagnieAeree" AS "C" ON "C"."IdCompagniaAerea" = "CompagniaAerea" ';
